...
const SkillsCard: FC<Props> = ({ item }) => {
  return (
    <div className=" sm:w-[95%] text-center h-[180px] rounded-2xl border hover:border-primary-color hover:shadow-[0_10px_40px_3px_rgba(0,0,0,0.2)] transition-all duration-300 hover:-translate-y-3 cursor-pointer group">
      <div

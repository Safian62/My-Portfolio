                        ...
                        <Card className='text-start w-[370px] pt-5 border-primary-color relative' key={index}>
                            ...
                            <CardFooter className='flex w-full justify-between absolute bottom-0'>
                                <Link href={project.url} target='_blank'>
                                    <div className="sm:w-[150px] bg-primary-color text-white border mt-5 sm:mt-0 h-[50px] mr-[-8px] rounded-3xl cursor-pointer flex justify-center items-center">
                                        <span id="span" className="inline-block font-bold text-center text-[16px]">Live Demo</span>
                                    </div></Link>
                                <Link href={project.code} target='_blank'>
                                    <div className=" bg-primary-color text-white sm:w-[150px] border mt-5 sm:mt-0 h-[50px] mr-[-8px] rounded-3xl cursor-pointer flex justify-center items-center">
